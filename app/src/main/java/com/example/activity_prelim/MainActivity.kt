package com.example.activity_prelim
...
import com.example.activity_prelim.ui.theme.Activity_PrelimTheme
    ...
    Box (
        ...
        Card(
            colors = CardDefaults.cardColors(
                containerColor = Color(5, 234, 255, 255),
        ...
        Card(
            colors = CardDefaults.cardColors(
                containerColor = Color(124, 238, 192, 255),
        ...
        Card( //q3
            colors = CardDefaults.cardColors(
                containerColor = Color(46, 255, 238, 255),
        ...
        Card( //q4
            colors = CardDefaults.cardColors(
                containerColor = Color(100, 241, 184, 255),
            ),
            shape = RectangleShape,
            modifier = Modifier
                .fillMaxWidth(0.5f)
